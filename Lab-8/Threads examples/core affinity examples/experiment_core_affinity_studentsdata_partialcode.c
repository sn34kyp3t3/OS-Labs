/******************************************************************************
  A "hello world" Pthreads program to experiment on core affinity and analyze the time taken in 5 different cases. The first two case are written. complete the remaining cases.
******************************************************************************/
